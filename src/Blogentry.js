...
const BlogEntry = ({blog}) => {
    return(
        <div style={{width: "220px", margin: "2%", backgroundColor:"white", border:"0.5px solid rgb(211,211,211,0.8)"}}>
            <center><img style={{width: "100%", height: "150px", objectFit:"cover", margin:"0"}}src={blog.image}></img></center>
            ...
            <h5>
            <img style={{height: "30px", width:"30px", objectFit:"cover", borderRadius: "50%", verticalAlign:"middle", float:"left", marginRight: "10px"}} src={blog.portrait}></img> 
            {blog.author}<br></br>
